...
const translations: Record<Language, Record<string, string>> = {
  ...
  rw: {
    ...
    "products.category.home": "Mu rugo", "products.category.kitchen": "Igikoni",
    "products.addToCart": "Ongeraho mu gasanduku",
    "cart.empty": "Agasanduku karimo ubusa", "cart.browse": "Reba ibicuruzwa",
    "cart.checkout": "Ishyura", "cart.clear": "Siba byose", "cart.orderPlaced": "Itegurwa ryashyizweho!",
    "delivery.tracking": "Gukurikirana", "delivery.courier": "Utwara",
    "delivery.note": "Inyandiko", "delivery.update": "Vugurura", "delivery.deliveredOn": "Byagejejwe",
  ...
  sw: {
    ...
    "products.category.home": "Nyumbani", "products.category.kitchen": "Jikoni",
    "products.addToCart": "Weka kikapuni",
    "cart.empty": "Kikapu chako ni tupu", "cart.browse": "Vinjari bidhaa",
    "cart.checkout": "Lipa", "cart.clear": "Futa kikapu", "cart.orderPlaced": "Agizo limewekwa!",
    "delivery.tracking": "Ufuatiliaji", "delivery.courier": "Mtoaji",
    "delivery.note": "Maelezo", "delivery.update": "Sasisha", "delivery.deliveredOn": "Ilitolewa",
  ...
  zh: {
    ...
    "products.category.home": "家居", "products.category.kitchen": "厨房",
    "products.addToCart": "加入购物车",
    "cart.empty": "购物车是空的", "cart.browse": "浏览产品",
    "cart.checkout": "结账", "cart.clear": "清空购物车", "cart.orderPlaced": "订单已下！",
    "delivery.tracking": "配送追踪", "delivery.courier": "快递",
    "delivery.note": "备注", "delivery.update": "更新", "delivery.deliveredOn": "送达于",
  ...
  fr: {
    ...
    "products.category.home": "Maison", "products.category.kitchen": "Cuisine",
    "products.addToCart": "Ajouter au panier",
    "cart.empty": "Votre panier est vide", "cart.browse": "Voir les produits",
    "cart.checkout": "Commander", "cart.clear": "Vider", "cart.orderPlaced": "Commande passée !",
    "delivery.tracking": "Suivi", "delivery.courier": "Coursier",
    "delivery.note": "Note", "delivery.update": "Mettre à jour", "delivery.deliveredOn": "Livré le",
